...
fn default_overlay_style() -> OverlayStyle {
    // Linux hides the overlay by default; other platforms show the minimal overlay.
...
fn default_post_process_provider_id() -> String {
    // Apple Intelligence is only offered on Apple Silicon; it needs no API key.
